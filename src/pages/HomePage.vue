...
<template>
  <div class="justify-between items-center md:flex">
    <h2 class="text-3xl font-bold whitespace-nowrap sm:mb-4">Все кроссовки</h2>

    <div class="md:flex items-center gap-4">
      <select
        @change="onChangeSelect"
        class="sm:mb-4 sm:py-1 sm:px-1 py-2 px-2 border rounded-md outline-none"
      >
      ...
      <div class="flex items-center relative">
        ...
        <input
          ...
          type="text"
          placeholder="Поиск..."
          class="max-w-[195px] border border-gray-300 rounded-md py-1.5 pl-10 pr-4 outline-none focus:border-gray-500"
        />
      </div>
    </div>
  </div>
